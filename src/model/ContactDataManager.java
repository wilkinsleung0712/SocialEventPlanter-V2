...
public class ContactDataManager {
	...
	/*
	 * Custom design exception to report the error when loading the contact manager
	 */
	...
	public String getContactEmail() throws ContactQueryException{
		...
		String email = null;
		try{
			cursor = this.context.getContentResolver().query(Email.CONTENT_URI, null, Email.CONTACT_ID+"=?", new String[]{intent.getData().getLastPathSegment()},null);
